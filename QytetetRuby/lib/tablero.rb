...
module ModeloQytetet
  ...
  class Tablero
    ...
    def to_s()
      #HACER BUCLE PARA RECORRER CASILLAS Y QUE LO VAYA METIENDO EN UN STRING Y LO DEVUELVE, ENTONCES LUEGO
